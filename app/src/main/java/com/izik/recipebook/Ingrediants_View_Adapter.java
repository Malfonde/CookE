...
public class Ingrediants_View_Adapter extends  BaseAdapter
{
    private final Context context;
    private ArrayList<Ingredient> Ingredients;

    public Ingrediants_View_Adapter(Context context,ArrayList<Ingredient> ingredientsquantities)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        View rowView = inflater.inflate(R.layout.view_quantity_list_row, parent, false);
        TextView ingredient_input = (TextView) rowView.findViewById(R.id.ingerdient_input_view);
        TextView quantity_input = (TextView) rowView.findViewById(R.id.quantity_input_view);
